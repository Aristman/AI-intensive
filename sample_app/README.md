...
## Рабочее окно (Файлы‑Редактор‑Правая панель)

Экран `WorkspaceScreen` — трёхпанельное окно для быстрой работы с файлами проекта на Desktop (Windows). Включает проводник слева, редактор с подсветкой по центру и каркас ленты событий справа.
...
- Правая панель:
  - Локальная лента сообщений (каркас) без интеграции агентов, поле ввода и отправка.
