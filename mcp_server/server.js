        ...
        if (method === 'tools/list') {
          const payload = {
            tools: [
              ...
              { name: 'tg_send_message', description: 'Send Telegram text message. If chat_id is not provided, uses TELEGRAM_DEFAULT_CHAT_ID from server config', inputSchema: { chat_id: 'string?', text: 'string', parse_mode: 'string?', disable_web_page_preview: 'boolean?' } },
              { name: 'tg_send_photo', description: 'Send Telegram photo by URL or file_id. If chat_id is not provided, uses TELEGRAM_DEFAULT_CHAT_ID from server config', inputSchema: { chat_id: 'string?', photo: 'string', caption: 'string?', parse_mode: 'string?' } },
              ...
              { name: 'create_issue_and_notify', description: 'Create GitHub issue and notify Telegram chat. If chat_id is not provided, uses TELEGRAM_DEFAULT_CHAT_ID from server config', inputSchema: { owner: 'string', repo: 'string', title: 'string', body: 'string?', chat_id: 'string?', message_template: 'string?' } },
